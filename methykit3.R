...
myobj=processBismarkAln(location=file.list,
                       ...
                       save.folder="/public/home/changjianye/project/shenxu_data/geese_MBH_WGBS/Batmeth2/BatMeth2_result/tmp",
                       save.context=NULL,read.context="CpG",
                       nolap=FALSE,mincov=10,minqual=20,
                       treatment=c(1))